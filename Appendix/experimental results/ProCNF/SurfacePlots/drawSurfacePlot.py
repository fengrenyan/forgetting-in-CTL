...
Z1 = np.loadtxt("totalAveTime.txt").reshape((9,9))
#surf1 = ax.plot_surface(X, Y, Z1, cmap=cm.coolwarm,

 #                      linewidth=0, antialiased=False, vmin=-1, vmax=1000)
surf = ax.plot_surface(X, Y, Z1, cmap=cm.coolwarm, rstride=1, cstride=1, antialiased=False, shade=False, alpha=1.0, linewidth=0, vmin=0, vmax=98)
